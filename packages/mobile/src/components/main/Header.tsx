...
const MainHeader: React.FC<HeaderProps> = (props) => {
  ...
  const newNotificationCount = notifications.filter(
    ...
    useEffect(() => {
        DeviceEventEmitter.addListener('headerTutorial', () => {
          ...
          <View style={styles.headerIconContainer}>
            ...
            <Pressable
              ...
              <Tooltip
                  ...
                  content={
                      isUploadTutorial ? <View style={{...pStyles.tooltipContainer, flex: 1, alignItems: 'center', justifyContent: 'flex-start'}}>
                              <Pressable onPress={() =>  setHomeTutorialDone(true)} style={{...pStyles.tooltipButton, width: 130}}>
                                  <Text style={pStyles.tooltipButtonText}>Upload</Text>
                              </Pressable>
                              <Pressable onPress={() =>  setHomeTutorialDone()} style={{...pStyles.tooltipButtonOutline, width: 130}}>
                                  <Text style={pStyles.tooltipButtonOutlineText}>Skip this Step</Text>
                              </Pressable>
                      </View> :
                          <View style={{...pStyles.tooltipContainer}}>
                              ...
                              <Pressable onPress={() =>  changeTutorialView()} style={pStyles.tooltipButton}>
